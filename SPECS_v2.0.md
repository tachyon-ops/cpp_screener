...
- Added §3.5: External Support/Resistance Provider interface (Nuno has existing SR indicator in another repo)
- Rewrote §5.7 stop management to match Nuno's actual strategy: immediate BE migration, trail on lower SR levels
- Added Pushover as optional parallel channel for Premium alerts (sub-second push)
- Clarified Telegram latency picture in §6.4
